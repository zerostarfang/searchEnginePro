    ...
    public static void main(String[] args) throws Exception {	
        ...
        try {
            ...
            while((urls = urlReader.readLine())!=null){
            	...
            	//urlInfo[0]存储url序号，urlInfo[2]存储url
            	String[] urlInfo;
            	urlInfo = urls.split("	");
            	...
            	BufferedReader contentReader = new BufferedReader(new InputStreamReader(urlCon.getInputStream()));
            	...
            	System.out.println(divFir);
            	Elements brandBoxes = divFir.getElementsByTag("div.uibox");

            	for (Element brandBox : brandBoxes) {
            		Elements dls = brandBox.getElementsByTag("dl");
            		...
            		for (Element dl : dls) {
            			...
            			String brandName = dt.text();
            			Elements lis = dl.getElementsByTag("li");
            			for (Element li : lis) {
            				Elements h4s = li.getElementsByTag("h4");
            				if (h4s == null || h4s.isEmpty()) {
            					continue;
            				}
            				Element h4 = h4s.first();
            				String seriesName = h4.text();
                        	Elements divs = li.getElementsByTag("div");
            				System.out.println(brandName + "," + seriesName);
            				bw.write(brandName + "," + seriesName);
            				bw.write("\r\n");
            			}
            		}
