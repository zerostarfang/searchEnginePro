...
public interface IDBAccessor<T extends Identifiable> {
	/**
	 * Add t to the database. Note: the ID property of t will be ignored!!!
	 * 
	 * @param t
	...
	/**
	 * Update t, which is in the database. Passing a t that not existing in the
	 * database will cause this method to fail.
	 * 
	 * @param t
	 * @return true if successed
	 */
	 ...
	 * @param key
	 *            格式�?属�?�?=�?;属�?�?=�?
	 * @return All t that satisfy the constrain in a Set.
	 */
