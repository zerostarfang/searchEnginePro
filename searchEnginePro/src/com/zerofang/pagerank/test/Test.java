...
public class Test {
	...
	public static void main(String[] args) throws IOException {
		// sql����
		/*
		 * sql = "select *from url";//SQL��� db1 = new
		 * DBHelper(sql);//����DBHelper����
		 * 
		 * try { ret = db1.pst.executeQuery();//ִ����䣬�õ���� while (ret.next())
		 * { String uid = ret.getString(1); String ufname = ret.getString(2);
		 * String ulname = ret.getString(3); System.out.println(uid + "\t" +
		 * ufname + "\t" + ulname ); }//��ʾ��� ret.close();
		 * db1.close();//�ر����� } catch (SQLException e) { e.printStackTrace();
		 * }
		 */
		// д����ݿ����
		 ...
		 * ������е�url��ǰ���صĴʲ����� Set<String> urls = new TreeSet<>(); while
